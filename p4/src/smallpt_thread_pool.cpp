...
{
    std::ofstream ofile("results/images/image3.ppm", std::ios::out);
    ofile << "P3" << std::endl;
    ofile << w << " " << h << std::endl;
    ofile << "255" << std::endl;
...
int main(int argc, char *argv[]){
    ...
    size_t region_w = w / w_div;
    size_t region_h = h / h_div;
    ...
    std::cout  << std::chrono::duration_cast<std::chrono::milliseconds>(stop-start).count() << "" << std::endl; //ms
